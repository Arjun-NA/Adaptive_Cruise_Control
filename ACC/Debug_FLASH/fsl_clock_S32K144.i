# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
...
# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
# 57 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h" 1
# 32 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h"
...
# 34 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/inc/fsl_scg_hal.h" 2
...
# 35 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h" 2
...
# 36 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h" 2
...
# 37 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h" 2
...
# 38 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h" 2
...
# 39 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h" 2
# 69 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h"
scg_status_t CLOCK_SYS_SetScgConfiguration(const scg_config_t *scgConfig);
# 79 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h"
void CLOCK_SYS_SetPccConfiguration(const pcc_config_t *peripheralClockConfig);
# 89 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h"
void CLOCK_SYS_SetSimConfiguration(const sim_clock_config_t *simClockConfig);
# 99 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.h"
void CLOCK_SYS_SetPmcConfiguration(const pmc_config_t *pmcConfig);
# 58 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c" 2
...
clock_manager_error_code_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                                             uint32_t *frequency);
# 59 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c" 2
...
# 61 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c" 2
# 75 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
...
static _Bool CLOCK_SYS_SwitchSystemClock(scg_system_clock_src_t to_clk);
...
# 111 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
clock_manager_error_code_t CLOCK_SYS_SetConfiguration(clock_manager_user_config_t const* config)
{
...
# 147 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
scg_status_t CLOCK_SYS_SetScgConfiguration(const scg_config_t *scgConfig)
{
    scg_status_t status;
    uint32_t timeout;
    ...
    if (scgConfig != ((void *)0))
    {
        ...
        SCG_HAL_GetSystemClockConfig(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_MODE_CURRENT, &current_config);
        ...
        if (scgConfig->sircConfig.initialize)
        {
            ...
            status = SCG_HAL_DeinitSirc(((SCG_Type *)(0x40064000u)));
            if (status == STATUS_SCG_SUCCESS)
            {

                status = SCG_HAL_InitSirc(((SCG_Type *)(0x40064000u)), &(scgConfig->sircConfig));
                ...
                if (status == STATUS_SCG_SUCCESS)
                {
                    ...
                    timeout = 26U;
                    while((SCG_HAL_GetSircFreq(((SCG_Type *)(0x40064000u))) == 0U) && (timeout > 0U))
                    {
                        timeout--;
                    }
        ...
        if (scgConfig->fircConfig.initialize && (status == STATUS_SCG_SUCCESS))
        {
            ...
            status = SCG_HAL_DeinitFirc(((SCG_Type *)(0x40064000u)));
            if (status == STATUS_SCG_SUCCESS)
            {

                status = SCG_HAL_InitFirc(((SCG_Type *)(0x40064000u)), &(scgConfig->fircConfig));
                if (status == STATUS_SCG_SUCCESS)
                {
        ...
        if (scgConfig->soscConfig.initialize && (status == STATUS_SCG_SUCCESS))
        {
            ...
            status = SCG_HAL_DeinitSysOsc(((SCG_Type *)(0x40064000u)));
            if (status == STATUS_SCG_SUCCESS)
            {

                status = SCG_HAL_InitSysOsc(((SCG_Type *)(0x40064000u)), &(scgConfig->soscConfig));
                if (status == STATUS_SCG_SUCCESS)
                {


                    timeout = 3205000U;
                    while((SCG_HAL_GetSysOscFreq(((SCG_Type *)(0x40064000u))) == 0U) && (timeout > 0U))
                    {
                        timeout--;
                    }
        ...
        if (scgConfig->spllConfig.initialize && (status == STATUS_SCG_SUCCESS))
        {
            ...
            status = SCG_HAL_DeinitSysPll(((SCG_Type *)(0x40064000u)));
            if (status == STATUS_SCG_SUCCESS)
            {


                status = SCG_HAL_InitSysPll(((SCG_Type *)(0x40064000u)), &(scgConfig->spllConfig));
                if (status == STATUS_SCG_SUCCESS)
                {
        ...
        if (status == STATUS_SCG_SUCCESS)
        {
            ...
            if (scgConfig->rtcConfig.initialize )
            {
                ...
                SCG_HAL_SetRtcClkInFreq(((SCG_Type *)(0x40064000u)), scgConfig->rtcConfig.rtcClkInFreq);
            }
            ...
            if (scgConfig->clockOutConfig.initialize)
            {
                ...
                SCG_HAL_SetClockoutSourceSel(((SCG_Type *)(0x40064000u)), scgConfig->clockOutConfig.source);
            }
            ...
            if (scgConfig->clockModeConfig.initialize)
            {
                ...
                SCG_HAL_SetSystemClockConfig(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_MODE_RUN, &(scgConfig->clockModeConfig.rccrConfig));
                SCG_HAL_SetSystemClockConfig(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_MODE_VLPR, &(scgConfig->clockModeConfig.vccrConfig));
                SCG_HAL_SetSystemClockConfig(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_MODE_HSRUN, &(scgConfig->clockModeConfig.hccrConfig));
            }
        }
    }
...
# 343 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
void CLOCK_SYS_SetPccConfiguration(const pcc_config_t *peripheralClockConfig)
{



    PCC_HAL_SetPeripheralClockConfig(((PCC_Type *)(0x40065000u)), peripheralClockConfig);
}
# 358 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
void CLOCK_SYS_SetSimConfiguration(const sim_clock_config_t *simClockConfig)
{
    ...
    {
        SIM_HAL_InitClkout(((SIM_Type *)(0x40048000u)), &(simClockConfig->clockOutConfig));
    }


    if (simClockConfig->lpoClockConfig.initialize)
    {
        SIM_HAL_SetLpoClocks(((SIM_Type *)(0x40048000u)), simClockConfig->lpoClockConfig);
    }


    if (simClockConfig->platGateConfig.initialize)
    {
        SIM_HAL_SetMscmClockGate(((SIM_Type *)(0x40048000u)), simClockConfig->platGateConfig.enableMscm);
        SIM_HAL_SetMpuClockGate(((SIM_Type *)(0x40048000u)), simClockConfig->platGateConfig.enableMpu);
        SIM_HAL_SetDmaClockGate(((SIM_Type *)(0x40048000u)), simClockConfig->platGateConfig.enableDma);
        SIM_HAL_SetErmClockGate(((SIM_Type *)(0x40048000u)), simClockConfig->platGateConfig.enableErm);
        SIM_HAL_SetEimClockGate(((SIM_Type *)(0x40048000u)), simClockConfig->platGateConfig.enableEim);
    }
    ...
    if (simClockConfig->tclkConfig.initialize)
    {
        for( i = 0; i< 3U; i++)
        {
            SIM_HAL_SetTClkFreq(((SIM_Type *)(0x40048000u)), i, simClockConfig->tclkConfig.tclkFreq[i]);
        }
    }
    ...
    {
        SIM_HAL_InitTraceClock(((SIM_Type *)(0x40048000u)), &(simClockConfig->traceClockConfig));
    }
}
# 411 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
void CLOCK_SYS_SetPmcConfiguration(const pmc_config_t *pmcConfig)
{
    ...
    if (pmcConfig->lpoClockConfig.initialize)
    {
        ...
        {
            PMC_HAL_SetLpoMode(((PMC_Type *)(0x4007D000u)),0);
        }
        else
        {
            PMC_HAL_SetLpoMode(((PMC_Type *)(0x4007D000u)),1);
        }


        if (PMC_MANUAL_CALIBRATION_MODE == pmcConfig->lpoClockConfig.calibrationMode)
        {
            PMC_HAL_SetLpoTrimValue(((PMC_Type *)(0x4007D000u)),pmcConfig->lpoClockConfig.trimValue);
        }
...
# 450 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
                                                            ...
                                                            uint32_t *frequency)
{
    ...
    switch (clockName)
    {
        ...
        case CORE_CLOCK:
            *frequency = SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)),SCG_SYSTEM_CLOCK_CORE);
            break;
        case BUS_CLOCK:
            *frequency = SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)),SCG_SYSTEM_CLOCK_BUS);
            break;
        case SLOW_CLOCK:
            *frequency = SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)),SCG_SYSTEM_CLOCK_SLOW);
            break;
        case CLKOUT_CLOCK:
            *frequency = CLOCK_SYS_GetSimClkOutFreq(((SIM_Type *)(0x40048000u)));
            break;


        case SIRC_CLOCK:
            *frequency = SCG_HAL_GetSircFreq(((SCG_Type *)(0x40064000u)));
            break;
        case FIRC_CLOCK:
            *frequency = SCG_HAL_GetFircFreq(((SCG_Type *)(0x40064000u)));
            break;
        case SOSC_CLOCK:
            *frequency = SCG_HAL_GetSysOscFreq(((SCG_Type *)(0x40064000u)));
            break;
        case SPLL_CLOCK:
            *frequency = SCG_HAL_GetSysPllFreq(((SCG_Type *)(0x40064000u)));
            break;
        case RTC_CLKIN_CLOCK:
            *frequency = SCG_HAL_GetRtcClkInFreq(((SCG_Type *)(0x40064000u)));
            break;
        case SCG_CLKOUT_CLOCK:
            *frequency = CLOCK_SYS_GetScgClkOutFreq(((SCG_Type *)(0x40064000u)));
            break;
        default:
                                                            ...
                                                            uint32_t *frequency)
{
    ...
    switch (clockName)
    {
        ...
        case SIM_FTM0_CLOCKSEL:
            *frequency = SIM_HAL_GetTClkFreq(((SIM_Type *)(0x40048000u)),(uint8_t)SIM_HAL_GetFtmExternalClkPinMode(((SIM_Type *)(0x40048000u)), 0U));
            break;
        case SIM_FTM1_CLOCKSEL:
            *frequency = SIM_HAL_GetTClkFreq(((SIM_Type *)(0x40048000u)),(uint8_t)SIM_HAL_GetFtmExternalClkPinMode(((SIM_Type *)(0x40048000u)), 1U));
            break;
        case SIM_FTM2_CLOCKSEL:
            *frequency = SIM_HAL_GetTClkFreq(((SIM_Type *)(0x40048000u)),(uint8_t)SIM_HAL_GetFtmExternalClkPinMode(((SIM_Type *)(0x40048000u)), 2U));
            break;
        case SIM_FTM3_CLOCKSEL:
            *frequency = SIM_HAL_GetTClkFreq(((SIM_Type *)(0x40048000u)),(uint8_t)SIM_HAL_GetFtmExternalClkPinMode(((SIM_Type *)(0x40048000u)), 3U));
            break;
        case SIM_CLKOUTSELL:
            *frequency = CLOCK_SYS_GetSimClkOutFreq(((SIM_Type *)(0x40048000u)));
            break;
        case SIM_RTCCLK_CLOCK:
            *frequency = CLOCK_SYS_GetSimRtcClkFreq(((SIM_Type *)(0x40048000u)));
            break;
        case SIM_LPO_CLOCK:
            *frequency = SIM_HAL_GetLpoFreq(((SIM_Type *)(0x40048000u)));
            break;
        case SIM_LPO_1K_CLOCK:
            *frequency = SIM_HAL_GetLpo1KFreq(((SIM_Type *)(0x40048000u)));
            break;
        case SIM_LPO_32K_CLOCK:
            *frequency = SIM_HAL_GetLpo32KFreq(((SIM_Type *)(0x40048000u)));
            break;
        case SIM_LPO_128K_CLOCK:
            if (PMC_HAL_GetLpoMode(((PMC_Type *)(0x4007D000u))))
            {
                *frequency = 128000;
            }
            break;
        case SIM_EIM_CLOCK:
            if (!SIM_HAL_GetEimClockGate(((SIM_Type *)(0x40048000u))))
            {
            ...
            break;
        case SIM_ERM_CLOCK:
            if (!SIM_HAL_GetErmClockGate(((SIM_Type *)(0x40048000u))))
            {
            ...
            break;
        case SIM_DMA_CLOCK:
            if (!SIM_HAL_GetDmaClockGate(((SIM_Type *)(0x40048000u))))
            {
            ...
            break;
        case SIM_MPU_CLOCK:
            if (!SIM_HAL_GetMpuClockGate(((SIM_Type *)(0x40048000u))))
            {
            ...
            break;
        case SIM_MSCM_CLOCK:
            if (!SIM_HAL_GetMscmClockGate(((SIM_Type *)(0x40048000u))))
            {
...
{ _Bool clockMode;
    ...
    {
        clockMode = PCC_HAL_GetClockMode(((PCC_Type *)(0x40065000u)),clockName);
        if (!clockMode)
        {
...
# 662 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/clock/S32K144/fsl_clock_S32K144.c"
clock_manager_error_code_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                                             uint32_t *frequency)
{
...
static uint32_t CLOCK_SYS_GetPeripheralClock(clock_names_t clockName, scg_async_clock_type_t divider)
{
    ...
    peripheral_clock_frac_t fracValue = PCC_HAL_GetFracValueSel(((PCC_Type *)(0x40065000u)),clockName);
    peripheral_clock_divider_t divValue = PCC_HAL_GetDividerSel(((PCC_Type *)(0x40065000u)),clockName);


    if (((uint32_t)fracValue) <= ((uint32_t)divValue))
    {

        if (PCC_HAL_GetClockMode(((PCC_Type *)(0x40065000u)),clockName))
        {

            switch (PCC_HAL_GetClockSourceSel(((PCC_Type *)(0x40065000u)),clockName))
            {
                case CLK_SRC_SOSC:
                    frequency = SCG_HAL_GetSysOscAsyncFreq(((SCG_Type *)(0x40064000u)),divider);
                    break;
                case CLK_SRC_SIRC:
                    frequency = SCG_HAL_GetSircAsyncFreq(((SCG_Type *)(0x40064000u)),divider);
                    break;
                case CLK_SRC_FIRC:
                    frequency = SCG_HAL_GetFircAsyncFreq(((SCG_Type *)(0x40064000u)),divider);
                    break;
                case CLK_SRC_SPLL:
                    frequency = SCG_HAL_GetSysPllAsyncFreq(((SCG_Type *)(0x40064000u)),divider);
                    break;
                default:
                    frequency = 0;
                    break;
...
static _Bool CLOCK_SYS_SwitchSystemClock(scg_system_clock_src_t to_clk)
{
    ...
    if ( to_clk != SCG_SYSTEM_CLOCK_SRC_NONE )
    {
        ...
        run_mode = CLOCK_SYS_GetCurrentRunMode(((SMC_Type *)(0x4007E000u)));

        if ( run_mode != SCG_SYSTEM_CLOCK_MODE_NONE )
        {

            SCG_HAL_GetSystemClockConfig(((SCG_Type *)(0x40064000u)), run_mode, &config);


            config.src = to_clk;


            SCG_HAL_SetSystemClockConfig(((SCG_Type *)(0x40064000u)), run_mode, &config);


            timeout = 100U;
            do {

                SCG_HAL_GetSystemClockConfig(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_MODE_CURRENT, &config);
                timeout--;
    ...
    if (sim_clkout_config.enable)
    {
        switch (sim_clkout_config.source)
        {
            ...
            case SIM_CLKOUT_SEL_SYSTEM_SOSC_DIV2_CLK:
                frequency = SCG_HAL_GetSysOscAsyncFreq(((SCG_Type *)(0x40064000u)), SCG_ASYNC_CLOCK_DIV2);
                break;
            case SIM_CLKOUT_SEL_SYSTEM_SIRC_DIV2_CLK:
                frequency = SCG_HAL_GetSircAsyncFreq(((SCG_Type *)(0x40064000u)), SCG_ASYNC_CLOCK_DIV2);
                break;
            case SIM_CLKOUT_SEL_SYSTEM_FIRC_DIV2_CLK:
                frequency = SCG_HAL_GetFircAsyncFreq(((SCG_Type *)(0x40064000u)), SCG_ASYNC_CLOCK_DIV2);
                break;
            case SIM_CLKOUT_SEL_SYSTEM_SPLL_DIV2_CLK:
                frequency = SCG_HAL_GetSysPllAsyncFreq(((SCG_Type *)(0x40064000u)), SCG_ASYNC_CLOCK_DIV2);
                break;
...
static uint32_t CLOCK_SYS_GetSimRtcClkFreq(const SIM_Type * base)
{
    ...
    switch (SIM_HAL_GetRtcClkSrc(base))
    {
        case SIM_RTCCLK_SEL_SOSCDIV1_CLK:
            frequency = SCG_HAL_GetSysOscAsyncFreq(((SCG_Type *)(0x40064000u)),SCG_ASYNC_CLOCK_DIV1);
            break;
        ...
        case SIM_RTCCLK_SEL_FIRCDIV1_CLK:
            frequency = SCG_HAL_GetFircAsyncFreq(((SCG_Type *)(0x40064000u)),SCG_ASYNC_CLOCK_DIV1);
            break;
        default:
