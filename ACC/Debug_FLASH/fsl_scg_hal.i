# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
...
# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
# 30 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
...
# 31 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c" 2
...
# 69 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetSystemClockFreq(const SCG_Type * base,
                                    scg_system_clock_type_t type)
{
    uint32_t freq;
...
# 133 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
void SCG_HAL_SetSystemClockConfig(SCG_Type * base,
                                  scg_system_clock_mode_t mode,
                                  scg_system_clock_config_t const *config)
{
    uint32_t value = (uint32_t)((((uint32_t)(config->src) << 24u) & 0xF000000u) |
                                (((uint32_t)(config->divCore) << 16u) & 0xF0000u) |
                                (((uint32_t)(config->divBus) << 4u) & 0xF0u) |
                                (((uint32_t)(config->divSlow) << 0u) & 0xFu) );
...
# 177 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
void SCG_HAL_GetSystemClockConfig(const SCG_Type * base,
                                  scg_system_clock_mode_t mode,
                                  scg_system_clock_config_t *config)
{
    ...
    switch (mode)
    {
        case SCG_SYSTEM_CLOCK_MODE_CURRENT:
            value = base->CSR;
            break;
        case SCG_SYSTEM_CLOCK_MODE_RUN:
            value = base->RCCR;
    ...
    config->divCore = systemClockDividerValues[(value & 0xF0000u) >> 16u];
    config->divBus = systemClockDividerValues[(value & 0xF0u) >> 4u ];
    config->divSlow = systemClockDividerValues[(value & 0xFu) >> 0u];
}
# 237 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
void SCG_HAL_GetSysOscDefaultConfig(scg_sosc_config_t *config)
{
    ...
    config->enableInStop = 0;
    config->enableInLowPower = 0;
    config->enableErClk = 0;
...
# 267 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
scg_status_t SCG_HAL_InitSysOsc(SCG_Type * base,
                                  scg_sosc_config_t const *config)
{
    scg_status_t retStatus = STATUS_SCG_SUCCESS;
    uint32_t regValue;
# 280 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
    if (((base->SOSCCSR & 0x2000000u) >> 25u) != 0U)
    {
    ...
    else
    {
        ...
        base->SOSCDIV = (((uint32_t)(((uint32_t)(config->div1))<<0u))&0x7u) |
                        (((uint32_t)(((uint32_t)(config->div2))<<8u))&0x700u);

        base->SOSCCFG = (((uint32_t)(((uint32_t)(config->range))<<4u))&0x30u) |
                        (((uint32_t)(((uint32_t)(config->gain))<<3u))&0x8u) |
                        (((uint32_t)(((uint32_t)(config->extRef))<<2u))&0x4u);

        base->SOSCCSR = (((uint32_t)(((uint32_t)(1U))<<0u))&0x1u) |
                        (((uint32_t)(((uint32_t)(((config->enableErClk) ? 1UL : 0UL)))<<3u))&0x8u);
        ...
        regValue &= (uint32_t)(~(0x800000u));
        regValue |= (((uint32_t)(((uint32_t)(((config->locked) ? 1UL : 0UL)))<<23u))&0x800000u);
...
# 327 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
scg_status_t SCG_HAL_DeinitSysOsc(SCG_Type * base)
{
    scg_status_t retStatus = STATUS_SCG_SUCCESS;
...
# 356 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetSysOscFreq(const SCG_Type * base)
{
    uint32_t retValue;
    if (((base->SOSCCSR & 0x1000000u) >> 24u) != 0U)
    {
...
# 377 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetSysOscAsyncFreq(const SCG_Type * base,
                                    scg_async_clock_type_t type)
{
...
# 425 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
void SCG_HAL_GetSircDefaultConfig(scg_sirc_config_t *config)
{
...
# 448 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
scg_status_t SCG_HAL_InitSirc(SCG_Type * base,
                                const scg_sirc_config_t *config)
{
    scg_status_t retStatus = STATUS_SCG_SUCCESS;
    uint32_t regValue;
# 461 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
    if (((base->SIRCCSR & 0x2000000u) >> 25u) != 0U)
    {
        retStatus = STATUS_SCG_BUSY;
    }
    else
    {
        ...
        base->SIRCCSR &= (uint32_t)(~(0x1u));



        base->SIRCDIV = (((uint32_t)(((uint32_t)(config->div1))<<0u))&0x7u) |
                        (((uint32_t)(((uint32_t)(config->div2))<<8u))&0x700u);

        base->SIRCCFG = (((uint32_t)(((uint32_t)(config->range))<<0u))&0x1u);

        base->SIRCCSR = (((uint32_t)(((uint32_t)(1U))<<0u))&0x1u) |
                        (((uint32_t)(((uint32_t)(((config->enableInStop) ? 1UL : 0UL )))<<1u))&0x2u) |
                        (((uint32_t)(((uint32_t)(((config->enableInLowPower) ? 1UL : 0UL )))<<2u))&0x4u);
...
# 497 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
scg_status_t SCG_HAL_DeinitSirc(SCG_Type * base)
{
...
# 526 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetSircFreq(const SCG_Type * base)
{
    uint32_t retValue;

    if (((base->SIRCCSR & 0x1000000u) >> 24u) != 0U)
    {
        retValue = (((base->SIRCCFG & 0x1u) >> 0u) != 0U) ?
                                  (8000000U) : (2000000U);
    }
    else
    {
...
# 549 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetSircAsyncFreq(const SCG_Type * base,
                                  scg_async_clock_type_t type)
{
...
# 597 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
void SCG_HAL_GetFircDefaultConfig(scg_firc_config_t *config)
{
...
# 628 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
scg_status_t SCG_HAL_InitFirc(SCG_Type * base,
                                const scg_firc_config_t *config)
{
    scg_status_t retStatus = STATUS_SCG_SUCCESS;
    uint32_t regValue;
# 641 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
    if (((base->FIRCCSR & 0x2000000u) >> 25u) != 0U)
    {
        retStatus = STATUS_SCG_BUSY;
    }
    else
    {
        ...
        base->FIRCCSR &= (uint32_t)(~(0x1u));

        base->FIRCCSR &= (uint32_t)(~(0x100u));

        base->FIRCCSR |= (((uint32_t)(((uint32_t)(1U))<<26u))&0x4000000u);



        base->FIRCDIV = (((uint32_t)(((uint32_t)(config->div1))<<0u))&0x7u) |
                        (((uint32_t)(((uint32_t)(config->div2))<<8u))&0x700u);


        base->FIRCCFG = (((uint32_t)(((uint32_t)(config->range))<<0u))&0x3u);
        ...
        if (config->enableTrim)
        {
            ...
            regValue &= (uint32_t)(~(0x3u));
            regValue |= (((uint32_t)(((uint32_t)(2UL))<<0u))&0x3u);
            base->FIRCTCFG = (uint32_t)regValue;


            if (config->updateTrim)
            {
                base->FIRCCSR |= (((uint32_t)(((uint32_t)(1UL))<<9u))&0x200u);
            }
            else
            {
                base->FIRCCSR &= (uint32_t)(~(0x200u));


                base->FIRCSTAT = (((uint32_t)(((uint32_t)(config->trimCoar))<<8u))&0x3F00u) |
                                 (((uint32_t)(((uint32_t)(config->trimFine))<<0u))&0x7Fu);
            }


            base->FIRCCSR |= (((uint32_t)(((uint32_t)(1UL))<<8u))&0x100u);
        }

        base->FIRCCSR = (base->FIRCCSR
                       & ~((0x1u) |
                           (0x8u)))
                       | ((((uint32_t)(((uint32_t)(1U))<<0u))&0x1u) |
                          (((uint32_t)(((uint32_t)((config->regulator ? 0UL : 1UL)))<<3u))&0x8u));
        ...
        if ((((base->FIRCCSR & 0x4000000u) >> 26u) != 0U) && config->enableTrim)
        {
...
# 719 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
scg_status_t SCG_HAL_DeinitFirc(SCG_Type * base)
{
    scg_status_t retStatus = STATUS_SCG_SUCCESS;
...
# 746 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetFircFreq(const SCG_Type * base)
{
    uint32_t retValue;
    ...
    if (((base->FIRCCSR & 0x1000000u) >> 24u) != 0U)
    {
        uint32_t regValue = base->FIRCCFG;
        regValue = (regValue & 0x3u) >> 0u;
...
# 777 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetFircAsyncFreq(const SCG_Type * base,
                                  scg_async_clock_type_t type)
{
...
# 824 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
void SCG_HAL_GetSysPllDefaultConfig(scg_spll_config_t *config)
{
...
# 851 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
scg_status_t SCG_HAL_InitSysPll(SCG_Type * base,
                                scg_spll_config_t const *config)
{
    scg_status_t retStatus = STATUS_SCG_SUCCESS;
    uint32_t srcFreq, regValue;
# 865 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
    if (((base->SPLLCSR & 0x2000000u) >> 25u) != 0U)
    {
        retStatus = STATUS_SCG_BUSY;
    }
    else
    {
        ...
        else
        {
            ...
            srcFreq /= (((uint32_t)config->prediv) + 1U);

            if ((srcFreq < 8000000U) || (srcFreq > 32000000U))
            {
            ...
            else
            {
                ...
                base->SPLLDIV = (((uint32_t)(((uint32_t)(config->div1))<<0u))&0x7u) |
                                (((uint32_t)(((uint32_t)(config->div2))<<8u))&0x700u);

                base->SPLLCFG = (((uint32_t)(((uint32_t)(config->prediv))<<8u))&0x700u) |
                                (((uint32_t)(((uint32_t)(config->mult))<<16u))&0x1F0000u) |
                                (((uint32_t)(((uint32_t)(config->src))<<0u))&0x1u);

                base->SPLLCSR = (((uint32_t)(((uint32_t)(1U))<<0u))&0x1u);
...
# 927 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
scg_status_t SCG_HAL_DeinitSysPll(SCG_Type * base)
{
    scg_status_t retStatus = STATUS_SCG_SUCCESS;
...
# 954 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetSysPllFreq(const SCG_Type * base)
{
    uint32_t freq, regValue, retValue;

    if (((base->SPLLCSR & 0x1000000u) >> 24u) != 0U)
    {
        ...
        if (freq != 0U)
        {
            ...
            regValue = base->SPLLCFG;
            regValue = (regValue & 0x1F0000u) >> 16u;
            freq *= (regValue + 16U);
...
# 992 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetSysPllAsyncFreq(const SCG_Type * base,
                                    scg_async_clock_type_t type)
{
...
# 1039 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
void SCG_HAL_SetRtcClkInFreq(SCG_Type * base, uint32_t frequency)
{
    (void) (base);
    g_RtcClkInFreq = frequency;;
}
# 1052 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/scg/fsl_scg_hal.c"
uint32_t SCG_HAL_GetRtcClkInFreq(SCG_Type * base)
{
    (void) (base);
