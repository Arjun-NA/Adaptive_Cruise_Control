# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
...
# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
# 60 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
...
# 35 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/inc/fsl_smc_hal.h" 2
...
# 36 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/inc/fsl_smc_hal.h" 2
...
# 61 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c" 2
# 71 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
static _Bool SMC_HAL_WaitForStatChange(const SMC_Type* const baseAddr, const power_mode_stat_t mode, const uint32_t timeout);


#define SMC_TIMEOUT 1000U
# 90 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
void SMC_HAL_GetVersion(const SMC_Type* const baseAddr, smc_version_info_t* const versionInfo)
{
    uint32_t regValue;

    regValue = baseAddr->VERID;
    regValue = (regValue & 0xFF000000u) >> 24u;
    versionInfo->majorNumber = regValue;

    regValue = baseAddr->VERID;
    regValue = (regValue & 0xFF0000u) >> 16u;
    versionInfo->minorNumber = regValue;

    regValue = baseAddr->VERID;
    regValue = (regValue & 0xFFFFu) >> 0u;
    versionInfo->featureNumber = regValue;
}
# 123 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
smc_hal_error_code_t SMC_HAL_SetPowerMode(SMC_Type* const baseAddr,
                                          const smc_power_mode_config_t* const powerModeConfig)
{
    ...
    {
      (((uint16_t)STAT_VLPR) | ((uint16_t)STAT_HSRUN)),
      (uint16_t)STAT_RUN,
      (uint16_t)STAT_RUN,
      (uint16_t)STAT_RUN,
      (uint16_t)STAT_VLPR,
      (((uint16_t)STAT_RUN) | ((uint16_t)STAT_VLPR)),
      (uint16_t)STAT_RUN,
    };
    ...
    else
    {
        ...
        case POWER_MODE_RUN:
            ...
            if (!SMC_HAL_WaitForStatChange(baseAddr,STAT_RUN,1000U))
            {
        ...
        case POWER_MODE_VLPR:
            ...
            if (!SMC_HAL_WaitForStatChange(baseAddr,STAT_VLPR,1000U))
            {
        ...
        case POWER_MODE_HSRUN:
            ...
            if (!SMC_HAL_WaitForStatChange(baseAddr,STAT_HSRUN,1000U))
            {
        ...
        case POWER_MODE_VLPW:
            ...
            ((FSL_SCB_Type *)(0xE000E000u))->SCR &= ~0x4u;
...
# 294 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
void SMC_HAL_SetProtectionMode(SMC_Type* const baseAddr,
                               const smc_power_mode_protection_config_t* const protectConfig)
{
...
# 326 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
_Bool SMC_HAL_GetProtectionMode(const SMC_Type* const baseAddr, const power_modes_protect_t protect)
{
    _Bool retValue;
    ...
    retValue = (regValue == 0UL) ? 0 : 1;
    return retValue;
}
# 366 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/smc/fsl_smc_hal.c"
static _Bool SMC_HAL_WaitForStatChange(const SMC_Type* const baseAddr, const power_mode_stat_t mode, const uint32_t timeout)
{
    uint32_t i;
    _Bool retValue;
