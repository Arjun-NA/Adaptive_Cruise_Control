# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
...
# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
# 56 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
...
# 57 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c" 2
# 70 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_Init(LPUART_Type * base)
{
...
# 103 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
lpuart_status_t LPUART_HAL_SetBaudRate(LPUART_Type * base,
                                       uint32_t sourceClockInHz,
                                       uint32_t desiredBaudRate)
{
    ...
    if (baudDiff < ((desiredBaudRate / 100U) * 3U))
    {
        ...
        if ((osr > 3U) && (osr < 8U))
        {
            base->BAUD = (base->BAUD & ~0x20000u) | ((uint32_t)1U << 17u);
        }


        baudRegValTemp = base->BAUD;
        baudRegValTemp &= ~(0x1F000000u);
        baudRegValTemp |= (((uint32_t)(((uint32_t)(osr - 1U))<<24u))&0x1F000000u);
        base->BAUD = baudRegValTemp;


        baudRegValTemp = base->BAUD;
        baudRegValTemp &= ~(0x1FFFu);
        baudRegValTemp |= (((uint32_t)(((uint32_t)(sbr))<<0u))&0x1FFFu);
        base->BAUD = baudRegValTemp;
    }
    else
    {
...
# 195 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
...
# 221 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_SetParityMode(LPUART_Type * base, lpuart_parity_mode_t parityModeType)
{
    base->CTRL = (base->CTRL & ~0x2u) | (((uint32_t)parityModeType >> 1U) << 1u);
    base->CTRL = (base->CTRL & ~0x1u) | (((uint32_t)parityModeType & 1U) << 0u);
}
# 234 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_Putchar9(LPUART_Type * base, uint16_t data)
{
...
# 256 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
lpuart_status_t LPUART_HAL_Putchar10(LPUART_Type * base, uint16_t data)
{
    ...
    base->CTRL = (base->CTRL & ~0x40000000u) | ((uint32_t)ninthDataBit << 30u);
    base->CTRL = (base->CTRL & ~0x80000000u) | ((uint32_t)tenthDataBit << 31u);
...
# 281 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_Getchar9(const LPUART_Type * base, uint16_t *readData)
{
...
# 298 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_Getchar10(const LPUART_Type * base, uint16_t *readData)
{
...
# 317 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
                                ...
                                uint32_t txSize)
{
    while (txSize-- > 0U)
    {
        while (((base->STAT >> 23u) & 1U) == 0U)
        {}

        LPUART_HAL_Putchar(base, *txBuff++);
    }
}
# 338 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
                                              ...
                                              uint32_t rxSize)
{
    ...
    while (rxSize-- > 0U)
    {
        while (((base->STAT >> 21u) & 1U) == 0U)
        {}

        LPUART_HAL_Getchar(base, rxBuff++);


        if (((base->STAT >> 19u) & 1U) > 0U)
        {
            base->STAT = (base->STAT & ~0x80000u) | (1UL << 19u);
...
# 370 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_SetIntMode(LPUART_Type * base, lpuart_interrupt_t intSrc, _Bool enable)
{
...
# 415 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
_Bool LPUART_HAL_GetIntMode(const LPUART_Type * base, lpuart_interrupt_t intSrc)
{
    uint32_t reg = (uint32_t)(intSrc) >> (16U);
    _Bool retVal = 0;
...
# 461 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_SetLoopbackCmd(LPUART_Type * base, _Bool enable)
{


    base->CTRL = (base->CTRL & ~0x80u) | ((enable ? 1U : 0U) << 7u);
...
# 484 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_SetSingleWireCmd(LPUART_Type * base, _Bool enable)
{


    base->CTRL = (base->CTRL & ~0x80u) | ((enable ? 1U : 0U) << 7u);
    base->CTRL = (base->CTRL & ~0x20u) | ((enable ? 1U : 0U) << 5u);
}
# 502 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
lpuart_status_t LPUART_HAL_SetReceiverInStandbyMode(LPUART_Type * base)
{
    lpuart_wakeup_method_t rxWakeMethod;
    _Bool lpuart_current_rx_state;
    ...
    else
    {
        ...
        base->CTRL = (base->CTRL & ~0x20000u) | ((uint32_t)1U << 17u);
        return LPUART_STAT_SUCCESS;
    }
}
# 535 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_SetIdleLineDetect(LPUART_Type * base,
                                  const lpuart_idle_line_config_t *config)
{
    ...
    base->CTRL = (base->CTRL & ~0x4u) | ((uint32_t)config->idleLineType << 2u);
    base->STAT = (base->STAT & ~0x8000000u) | ((uint32_t)config->rxWakeIdleDetect << 27u);
}
# 553 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_SetMatchAddressReg1(LPUART_Type * base, _Bool enable, uint8_t value)
{
    uint32_t matchRegValTemp;


    base->BAUD &= ~0x80000000u;
    if (enable)
    {
        matchRegValTemp = base->MATCH;
        matchRegValTemp &= ~(0x3FFu);
        matchRegValTemp |= (((uint32_t)(((uint32_t)(value))<<0u))&0x3FFu);
        base->MATCH = matchRegValTemp;

        base->BAUD = (base->BAUD & ~0x80000000u) | ((uint32_t)1U << 31u);
    }
}
# 577 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_SetMatchAddressReg2(LPUART_Type * base, _Bool enable, uint8_t value)
{
    uint32_t matchRegValTemp;


    base->BAUD &= ~0x40000000u;
    if (enable)
    {
        matchRegValTemp = base->MATCH;
        matchRegValTemp &= ~(0x3FF0000u);
        matchRegValTemp |= (((uint32_t)(((uint32_t)(value))<<16u))&0x3FF0000u);
        base->MATCH = matchRegValTemp;

        base->BAUD = (base->BAUD & ~0x40000000u) | ((uint32_t)1U << 30u);
    }
}
# 602 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
void LPUART_HAL_SetInfrared(LPUART_Type * base, _Bool enable,
                            lpuart_ir_tx_pulsewidth_t pulseWidth)
{
    ...
    base->MODIR = (base->MODIR & ~0x40000u) | ((enable ? 1UL : 0UL) << 18u);


    modirRegValTemp = base->MODIR;
    modirRegValTemp &= ~(0x30000u);
    modirRegValTemp |= (((uint32_t)(((uint32_t)(pulseWidth))<<16u))&0x30000u);
    base->MODIR = modirRegValTemp;
}
# 625 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
_Bool LPUART_HAL_GetStatusFlag(const LPUART_Type * base, lpuart_status_flag_t statusFlag)
{
...
# 668 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/lpuart/fsl_lpuart_hal.c"
                                           ...
                                           lpuart_status_flag_t statusFlag)
{
    ...
    switch(statusFlag)
    {
        ...
        case LPUART_IDLE_LINE_DETECT:
            base->STAT = (base->STAT & ~0x100000u) | ((uint32_t)1U << 20u);
            break;

        case LPUART_RX_OVERRUN:
            base->STAT = (base->STAT & ~0x80000u) | ((uint32_t)1U << 19u);
            break;

        case LPUART_NOISE_DETECT:
            base->STAT = (base->STAT & ~0x40000u) | ((uint32_t)1U << 18u);
            break;

        case LPUART_FRAME_ERR:
            base->STAT = (base->STAT & ~0x20000u) | ((uint32_t)1U << 17u);
            break;

        case LPUART_PARITY_ERR:
            base->STAT = (base->STAT & ~0x10000u) | ((uint32_t)1U << 16u);
            break;

        case LPUART_LIN_BREAK_DETECT:
            base->STAT = (base->STAT & ~0x80000000u) | ((uint32_t)1U << 31u);
            break;

        case LPUART_RX_ACTIVE_EDGE_DETECT:
            base->STAT = (base->STAT & ~0x40000000u) | ((uint32_t)1U << 30u);
            break;


        case LPUART_MATCH_ADDR_ONE:
            base->STAT = (base->STAT & ~0x8000u) | ((uint32_t)1U << 15u);
            break;
        case LPUART_MATCH_ADDR_TWO:
            base->STAT = (base->STAT & ~0x4000u) | ((uint32_t)1U << 14u);
            break;


        case LPUART_FIFO_TX_OF:
            base->FIFO = (base->FIFO & ~0x20000u) | ((uint32_t)1U << 17u);
            break;
        case LPUART_FIFO_RX_UF:
            base->FIFO = (base->FIFO & ~0x10000u) | ((uint32_t)1U << 16u);
            break;
