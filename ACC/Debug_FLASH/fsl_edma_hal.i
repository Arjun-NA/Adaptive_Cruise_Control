# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
...
# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
# 30 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
...
# 34 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/inc/fsl_edma_hal.h" 2
...
# 36 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/inc/fsl_edma_hal.h" 2
...
# 31 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c" 2
# 43 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_Init(DMA_Type * base)
{
    uint32_t i;
...
# 71 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_CancelTransfer(DMA_Type * base)
{
    uint32_t regValTemp;
    regValTemp = base->CR;
...
# 89 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_CancelTransferWithError(DMA_Type * base)
{
    uint32_t regValTemp;
    regValTemp = base->CR;
...
# 107 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_SetErrorIntCmd(DMA_Type * base, edma_channel_indicator_t channel, _Bool enable)
{
    if (enable)
    {
...
# 126 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_SetDmaRequestCmd(DMA_Type * base, edma_channel_indicator_t channel,_Bool enable)
{
...
# 146 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_TCDClearReg(DMA_Type * base,uint32_t channel)
{
...
# 168 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_TCDSetAttribute(
                DMA_Type * base, uint32_t channel,
                edma_modulo_t srcModulo, edma_modulo_t destModulo,
                edma_transfer_size_t srcTransferSize, edma_transfer_size_t destTransferSize)
{
    ...
    regValTemp = ((uint16_t)srcModulo << 11u) | ((uint16_t)srcTransferSize << 8u);
    regValTemp |= ((uint16_t)destModulo << 3u) | ((uint16_t)destTransferSize << 0u);
...
# 230 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
uint32_t EDMA_HAL_TCDGetNbytes(const DMA_Type * base, uint32_t channel)
{
    ...
    if (((base->CR & 0x80u) >> 7u) != 0UL)
    {
        ...
        if (mlOffNo)
        {
            result = ((base->TCD[channel].NBYTES.MLOFFYES & 0x3FFu) >> 0u);
        }
        else
        {
            result = ((base->TCD[channel].NBYTES.MLOFFNO & 0x3FFFFFFFu) >> 0u);
        }
    }
    else
    {
        result = ((base->TCD[channel].NBYTES.MLNO & 0xFFFFFFFFu) >> 0u);
    }
    return result;
}
# 271 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_TCDSetMinorLoopOffset(DMA_Type * base, uint32_t channel, int32_t offset)
{
...
# 321 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_TCDSetChannelMinorLink(
                DMA_Type * base, uint32_t channel, uint32_t linkChannel, _Bool enable)
{
    ...
    regValTemp &= ~(0x8000u);
    regValTemp |= (((uint16_t)(((uint16_t)(enable ? 1UL : 0UL))<<15u))&0x8000u);
    ...
    if (enable)
    {
        ...
        regValTemp = base->TCD[channel].BITER.ELINKYES;
        regValTemp &= ~(0x1E00u);
        regValTemp |= (((uint16_t)(((uint16_t)(linkChannel))<<9u))&0x1E00u);
        base->TCD[channel].BITER.ELINKYES = regValTemp;
...
# 362 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
void EDMA_HAL_TCDSetMajorCount(DMA_Type * base, uint32_t channel, uint32_t count)
{
    ...
    if (((base->TCD[channel].BITER.ELINKNO & 0x8000u) >> 15u) != 0U)
    {
        regValTemp = base->TCD[channel].BITER.ELINKYES;
        regValTemp &= ~(0x1FFu);
        regValTemp |= (((uint16_t)(((uint16_t)(count))<<0u))&0x1FFu);
        base->TCD[channel].BITER.ELINKYES = regValTemp;
    ...
    else
    {
        ...
        regValTemp &= ~(0x7FFFu);
        regValTemp |= (((uint16_t)(((uint16_t)(count))<<0u))&0x7FFFu);
...
# 403 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
uint32_t EDMA_HAL_TCDGetBeginMajorCount(const DMA_Type * base, uint32_t channel)
{
    ...
    if (((base->TCD[channel].BITER.ELINKNO & 0x8000u) >> 15u) != 0U)
    {
        result = ((base->TCD[channel].BITER.ELINKYES & 0x1FFu) >> 0u);
    }
    else
    {
        result = ((base->TCD[channel].BITER.ELINKNO & 0x7FFFu) >> 0u);
    }
    return (uint32_t) result;
}
# 428 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
uint32_t EDMA_HAL_TCDGetCurrentMajorCount(const DMA_Type * base, uint32_t channel)
{
    ...
    if (((base->TCD[channel].BITER.ELINKNO & 0x8000u) >> 15u) != 0U)
    {
        result = ((base->TCD[channel].CITER.ELINKYES & 0x1FFu) >> 0u);
    }
    else
    {
        result = ((base->TCD[channel].CITER.ELINKNO & 0x7FFFu) >> 0u);
    }
    return (uint32_t) result;
}
# 454 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
uint32_t EDMA_HAL_TCDGetUnfinishedBytes(const DMA_Type * base, uint32_t channel)
{
...
# 484 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/src/edma/fsl_edma_hal.c"
uint32_t EDMA_HAL_TCDGetFinishedBytes(const DMA_Type * base, uint32_t channel)
{
