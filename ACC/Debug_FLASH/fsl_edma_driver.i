# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
...
# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
# 62 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
...
# 54 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/inc/fsl_edma_driver.h" 2
...
# 35 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/hal/inc/fsl_edma_hal.h" 2
...
# 63 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c" 2
# 1 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/inc/fsl_clock_manager.h" 1
# 64 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c" 2
...
# 65 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c" 2
...
# 90 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_Init(edma_state_t *edmaState, const edma_user_config_t *userConfig)
{
    ...
    if ((edmaState == ((void *)0)) || (userConfig == ((void *)0)))
    {
    ...
    if (edmaStatus == EDMA_STATUS_SUCCESS)
    {
        clockStatus = CLOCK_SYS_GetFreq(dmaClockName, ((void *)0));
        ...
        {
            clockStatus = CLOCK_SYS_GetFreq(dmamuxClockName, ((void *)0));
            if (clockStatus == CLOCK_MANAGER_NO_CLOCK)
            {
...
# 197 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_Deinit(void)
{
    uint32_t i;
    IRQn_Type irqNumber;
...
# 239 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_ChannelInit(edma_chn_state_t *edmaChannelState, const edma_channel_config_t *edmaChannelConfig)
{
    ...
    if ((edmaChannelState == ((void *)0)) || (edmaChannelConfig == ((void *)0)))
    {
    ...
    if (status == EDMA_STATUS_SUCCESS)
    {
        if ((edmaChannelConfig->channel > (16U)) &&
...
# 301 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_InstallCallback(edma_chn_state_t *chn, edma_callback_t callback, void *parameter)
{
    edma_status_t status = EDMA_STATUS_SUCCESS;
    if (chn == ((void *)0))
...
# 323 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_RequestChannel(uint8_t requestedChannel, dma_request_source_t source,
                                      edma_chn_state_t *chn, uint8_t * allocatedChannel)
{
    edma_status_t status = EDMA_STATUS_SUCCESS;
    if ((chn == ((void *)0)) || (allocatedChannel == ((void *)0)))
    {
        status = EDMA_STATUS_INVALID_ARGUMENT;
    }
    if (status == EDMA_STATUS_SUCCESS)
    ...
    if (status == EDMA_STATUS_SUCCESS)
    {
        ...
        if (requestedChannel == (uint8_t) EDMA_ANY_CHANNEL)
        {
            ...
            *allocatedChannel = (uint8_t) EDMA_INVALID_CHANNEL;
            ...
            for (i=0U; i < (16U); i++)
            {
                if (OSIF_MutexLock(&s_edma->lock, 0xFFFFFFFFu) == OSIF_STATUS_SUCCESS)
                {
                    _Bool exitLoop = 0;
                    if (!s_edma->chn[i])
                    {
...
static edma_status_t EDMA_DRV_ClaimChannel(uint8_t channel, dma_request_source_t source, edma_chn_state_t *chn)
{
    ...
    if (status == EDMA_STATUS_SUCCESS)
    {
        ...
        EDMA_HAL_SetErrorIntCmd(edmaRegBase, (edma_channel_indicator_t)channel, 1);


        DMAMUX_HAL_SetChannelCmd(dmamuxRegBase, channel, 0);
        DMAMUX_HAL_SetChannelSource(dmamuxRegBase, channel, (uint8_t)source);
        DMAMUX_HAL_SetChannelCmd(dmamuxRegBase, channel, 1);
...
# 460 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_ReleaseChannel(edma_chn_state_t *chn)
{
    uint8_t channel;
    DMA_Type * edmaRegBase;
    ...
    if (status == EDMA_STATUS_SUCCESS)
    {
        ...
        if (status == EDMA_STATUS_SUCCESS)
        {
            ...
            EDMA_HAL_SetDmaRequestCmd(edmaRegBase, (edma_channel_indicator_t)channel, 0);
...
# 546 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
void EDMA_DRV_IRQHandler(uint8_t channel)
{
...
# 568 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
void EDMA_DRV_ErrorIRQHandler(void)
{
    uint8_t channel = 0U;
    uint32_t error;
    ...
    EDMA_HAL_SetHaltCmd(edmaRegBase, 0);
}
# 607 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_ConfigSingleBlockTransfer(
                            const edma_chn_state_t *chn, edma_transfer_type_t type,
                            uint32_t srcAddr, uint32_t destAddr,
                            edma_transfer_size_t transferSize, uint32_t dataBufferSize)
{
    ...
    if (status == EDMA_STATUS_SUCCESS)
    {
        ...
        EDMA_HAL_TCDSetIntCmd(edmaRegBase, chn->channel, 1);
    }
    return status;
}
# 695 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_ConfigLoopTransfer(const edma_chn_state_t *chn, const edma_transfer_config_t *transferConfig)
{
    ...
    edma_status_t status = EDMA_STATUS_SUCCESS;
    if ((chn == ((void *)0)) || (transferConfig == ((void *)0)))
    {
        status = EDMA_STATUS_INVALID_ARGUMENT;
    }
    ...
    if (status == EDMA_STATUS_SUCCESS)
    {
        if (transferConfig->loopTransferConfig == ((void *)0))
        {
            status = EDMA_STATUS_INVALID_ARGUMENT;
        }
    }
    ...
    if (status == EDMA_STATUS_SUCCESS)
    {
        ...
        DMA_Type * edmaRegBase = g_edmaBase[0U];
        EDMA_HAL_SetMinorLoopMappingCmd(edmaRegBase, 1);
...
# 739 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_ConfigScatterGatherTransfer(
                        const edma_chn_state_t *chn, edma_software_tcd_t *stcd,
                        edma_transfer_size_t transferSize, uint32_t bytesOnEachRequest,
                        const edma_scatter_gather_list_t *srcList, const edma_scatter_gather_list_t *destList,
                        uint8_t tcdCount)
{
    ...
    edma_status_t status = EDMA_STATUS_SUCCESS;
    if ((chn == ((void *)0)) || (stcd == ((void *)0)) || (srcList == ((void *)0)) || (destList == ((void *)0)))
    {
        status = EDMA_STATUS_INVALID_ARGUMENT;
    }
...
# 893 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_StartChannel(const edma_chn_state_t *chn)
{
    ...
    if (status == EDMA_STATUS_SUCCESS)
    {
        EDMA_HAL_SetDmaRequestCmd(edmaRegBase, (edma_channel_indicator_t)channel, 1);
    }
    return status;
}
# 917 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_StopChannel(const edma_chn_state_t *chn)
{
    uint8_t channel = chn->channel;
    DMA_Type * edmaRegBase = g_edmaBase[0U];
...
# 941 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
void EDMA_DRV_PushConfigToSTCD(const edma_chn_state_t *chn, const edma_transfer_config_t *config, edma_software_tcd_t *stcd)
{
    if ((chn != ((void *)0)) && (config != ((void *)0)) && (stcd != ((void *)0)))
    {

        EDMA_DRV_ClearSoftwareTCD(stcd);


        stcd->ATTR = (((uint16_t)config->srcModulo) << 11u) | (((uint16_t)config->srcTransferSize) << 8u) |
...
# 979 "C:/NXP/S32DS_ARM_v1.3/S32DS/S32_SDK_EAR_0.8.2/platform/drivers/src/edma/fsl_edma_driver.c"
edma_status_t EDMA_DRV_PushConfigToReg(const edma_chn_state_t *chn, const edma_transfer_config_t *tcd)
{
    uint32_t channel;
    DMA_Type * edmaRegBase = g_edmaBase[0U];
    edma_status_t status = EDMA_STATUS_SUCCESS;
    if ((chn == ((void *)0)) || (tcd == ((void *)0)))
    {
        status = EDMA_STATUS_INVALID_ARGUMENT;
    }
    else
    {
        ...
        {
            EDMA_HAL_TCDSetScatterGatherCmd(edmaRegBase, channel, 1);
            EDMA_HAL_TCDSetScatterGatherLink(edmaRegBase, channel, tcd->scatterGatherNextDescAddr);
        }
        else
        {
            EDMA_HAL_TCDSetScatterGatherCmd(edmaRegBase, channel, 0);
