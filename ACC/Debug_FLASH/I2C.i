...
void LPI2C0_init(void)
{
    ((LPI2C_Type *)(0x40066000u))->MCCR0 = 0x0204050B;
    ...
    ((LPI2C_Type *)(0x40066000u))->MIER = 0x3C00;
# 79 "../Sources/I2C.c"
    ((LPI2C_Type *)(0x40066000u))->MCFGR0 = 0x0000;
    ...
    ((LPI2C_Type *)(0x40066000u))->MCFGR1 = 0x00000900;
# 96 "../Sources/I2C.c"
    ((LPI2C_Type *)(0x40066000u))->MCFGR2 = 0x0000001F;





    ((LPI2C_Type *)(0x40066000u))->MCFGR3 = 0x00000200;



    ((LPI2C_Type *)(0x40066000u))->MFCR = 0x00000000;




    ((LPI2C_Type *)(0x40066000u))->MCR = 0x901;
...
void LPI2C0_clock(void)
{
    ((PCC_Type *)(0x40065000u))->PCCn[102] |= (((uint32_t)(((uint32_t)(2))<<24u))&0x7000000u);
    ((PCC_Type *)(0x40065000u))->PCCn[102] |= 0x40000000u;
}
...
static uint8_t bus_busy(void)
{
     ...
     while ((((LPI2C_Type *)(0x40066000u))->MSR & (1 << 25)) && (timeout_b < 1000)) ++timeout_b;

     if(timeout_b >= 1000) return (error |= (1 << BUSY));
...
static void generate_start_ACK(uint8_t address)
{
    ...
    command |= (0b100 << 8);
    ((LPI2C_Type *)(0x40066000u))->MTDR = command;
}
...
static void transmit_data(uint8_t data)
{
    ((LPI2C_Type *)(0x40066000u))->MTDR = data;
}
# 218 "../Sources/I2C.c"
static void receive_data(uint8_t *p_buffer, uint8_t n_bytes)
{
    ...
    while (((((LPI2C_Type *)(0x40066000u))->MFSR) >> 16 != n_bytes) && (time < timeout_r)) ++time;

    if(time >= timeout_r)
    {
        ((LPI2C_Type *)(0x40066000u))->MCR |= (1 << 9);
        error |= (1 << NO_DATA_RECEIVED);
    }
    else{
        for(n = 0; n < n_bytes; ++n)
        {
            p_buffer[n] = (uint8_t)(((LPI2C_Type *)(0x40066000u))->MRDR & 0x000000FF);
...
static uint8_t generate_stop(void)
{
    ...
    ((LPI2C_Type *)(0x40066000u))->MTDR = 0x0200;

    while((!(((LPI2C_Type *)(0x40066000u))->MSR & (1 << 9))) && (!stop_sent_err))
    {
        if(timeout_s > 3000)
        {
            error |= (1 << NO_STOP);
    ...
    if(((LPI2C_Type *)(0x40066000u))->MSR & (1 << 9))
    {
        ((LPI2C_Type *)(0x40066000u))->MSR |= (1 << 9);
    }
...
{
    if(((LPI2C_Type *)(0x40066000u))->MSR & (1 << 10))
    {
        error |= (1 << NDF);



        ((LPI2C_Type *)(0x40066000u))->MSR = 0x400;
    }

    if(((LPI2C_Type *)(0x40066000u))->MSR & (1 << 11))
    {
        error |= (1 << ALF);



        ((LPI2C_Type *)(0x40066000u))->MCR |= (1 << 8);
        ((LPI2C_Type *)(0x40066000u))->MCR |= (1 << 9);
        ((LPI2C_Type *)(0x40066000u))->MSR = 0x800;
    }

    if(((LPI2C_Type *)(0x40066000u))->MSR & (1 << 12))
    {
        error |= (1 << FEF);
        ...
        ((LPI2C_Type *)(0x40066000u))->MCR |= (1 << 8);
        ((LPI2C_Type *)(0x40066000u))->MCR |= (1 << 9);
        ((LPI2C_Type *)(0x40066000u))->MSR = 0x1000;
    }

    if(((LPI2C_Type *)(0x40066000u))->MSR & (1 << 13))
    {
        error |= (1 << PLTF);
        ...
        ((LPI2C_Type *)(0x40066000u))->MSR = 0x2000;

        ((LPI2C_Type *)(0x40066000u))->MCR |= (1 << 1);
        ((LPI2C_Type *)(0x40066000u))->MCR &= ~(1 << 1);
        LPI2C0_init();
    }
}
...
void LPI2C0_IRQs(void)
{
    ...
    ((FSL_NVIC_Type *)(0xE000E100u))->ICPR[0] = (1 << (24 % 32));
    ((FSL_NVIC_Type *)(0xE000E100u))->ISER[0] = (1 << (24 % 32));
    ((FSL_NVIC_Type *)(0xE000E100u))->IP[24] = 0x00;
}
